...
export default class ReactOwlCarousel extends React.Component<OwlCarouselProps> {
    ...
    private containerRef: React.Ref<HTMLDivElement> = (inst) => {
        this.container = inst;
    }
}

const OPTIONS = new Set([
    'rtl', // —лайды движутс¤ слева направо.
